...
$$
    ...
    BEGIN
        ...
        INSERT INTO bank_account (account_id, user_id, account_name, account_number, cvv, expires_at, balance)
        VALUES (account_id_1, user_id_1, 'ImportedForJohn', 'PL12345678901234567890123456', '123', '2027-01-05 00:00:00'::timestamp, 1000),
               (account_id_2, user_id_2, 'ImportedForJane', 'PL09876543210987654321098765', '321', '2027-01-05 00:00:00'::timestamp, 1000);
